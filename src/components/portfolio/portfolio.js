          ...
          <div className="twelve columns collapsed">
            ...
            <form className={classes.root} autoComplete="off">
              <FormControl className={classes.formControl}>
                ...
                <Select value={this.state.category} onChange={this.handleChange} inputProps={{ name: 'category', id: "age-simple"}}>
            ...
            <div id="portfolio-wrapper" className="bgrid-quarters s-bgrid-thirds cf">
              {portfolioData.map((e, i) => {
                ...
                else if (portfolioData[i].categories == this.state.category) {
                  return <Modal portfolioData={portfolioData[i]} />
                }
              })}
            </div>
