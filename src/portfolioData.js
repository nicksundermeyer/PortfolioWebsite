...
let resumeData = [
    {
        ...
        "body":
            <div>
                <p><a href="https://sundy.itch.io/blankcanvas">View and download the game on itch.io</a></p>
                <p>This was my senior game capstone project for my Game Development major, created over the course of 30 weeks along with a team of two other programmers.</p>
    ...
    },
    {
        ...
        "body":
            <div>
                <p> This was a project created in Unreal Engine 4 for my Game Programming 2 class. With this project, I learned to use the Unreal engine, including both Blueprints and C++. The final project is a bit eclectic because I was learning along the way, but UE4 is a great tool and I learned a lot from working with it. </p>
                <p> The game is a first-person platformer/puzzler, with three levels that the player can go through in any order. Players try to complete each level as quickly as possible, which involves a combination of dodging various enemies and traps, as well as opening doors using special 'keys' and smashing through rock formations with a hammer. I think the most challenging aspect of this project was keeping the game as a coherent experience as I learned each part of the engine along the way, and avoiding feature creep as I began to open up the possibilities of the engine. </p>
                <iframe src='https://www.youtube-nocookie.com/embed/SPDKFkvGXs0?rel=0&amp;showinfo=0' frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>
            </div>
    },
    {
        "header": "AR Projects",
    ...
    },
    {
        ...
        "body":
            <div>
                <iframe src='https://drive.google.com/file/d/1qDKmeZPwnL-c8p5L9eZ3mnklHEGHrHiF/preview'></iframe>
    ...
    },
    {
        ...
        "body":
            <div>
                ...
                <div id="carouselOne" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Render1.png" alt="First slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Render2.png" alt="Second slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Render3.png" alt="Third slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Render4.png" alt="Third slide"></img>
                        </div>
                    </div>
                ...
                <p>The goal of this first project was to get comfortable with modeling tools and basic materials. Our assignment was to take a modern piece to technology and reimagine how it would work during an older era. I took the idea of a museum exhibit and created this steampunk version of a display about tectonic plate movement, using a steam engine at the bottom to drive the plates around on the central arms.</p>
                <div id="carouselTwo" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Scene1_1.png" alt="First slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Scene1_2.png" alt="Second slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Scene1_3.png" alt="Third slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Scene2_1.png" alt="Third slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Scene2_2.png" alt="Third slide"></img>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="/images/portfolio/modelingModal/Scene2_3.png" alt="Third slide"></img>
                        </div>
                    </div>
                ...
                <p>This second project was focused mainly on learning about lighting, UV mapping, and texturing. In this case, the prompt was to create a scene in two different states. I chose to create a neighborhood street before and after an oppressive government takes over. By changing the lighting and making the scene much more sparse, I hoped to change the viewer’s perception of the space between the two versions.</p>
            </div>
    ...
    },
    {
        ...
        "body":
            <div>
                <p>This was a small personal project created as a gift for a family member, but I'm proud of how it turned out. It's a portrait of our family dog, and I tried hard to capture his personality as best I could. I have always really loved this polygonal art style but had never tried to work with it before, so I was glad to get the chance to try it for myself.</p>
            </div>
    },
    {
    ...
    },
    {
        ...
        "body":
            <div>
                <p>This is a render of a group of models that I made for an animation for the Paly Robotics team. I modeled and UV mapped four buildings (a store, a small wooden shack, a larger modern-style house, and a classic tile-roofed house), as well as the fence, viking hat, and stop sign in the image. The final models were eventually rendered in a 3rd party renderer, Octane, to improve lighting as well as add post-processing effects.</p>
            </div>
    }
]
